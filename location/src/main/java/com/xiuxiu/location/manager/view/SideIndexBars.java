package com.xiuxiu.location.manager.view;
 ...
 * @Date: 2018/2/8 10:56
 */
public class SideIndexBars extends View {
    ...
    public SideIndexBars(Context context) {
        this(context, null);
    }

    public SideIndexBars(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideIndexBars(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public SideIndexBars setOverlayTextView(TextView overlay){
        this.mOverlayTextView = overlay;
        return this;
    }

    public SideIndexBars setOnIndexChangedListener(OnIndexTouchedChangedListener listener){

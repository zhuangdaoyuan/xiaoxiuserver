...
import com.monster.gamma.core.TargetContext;
...
public class GammaUtil {
    public static TargetContext getTargetContext(Object target) {
        ...
        if (oldContent == null) {
            throw new IllegalArgumentException(String.format("enexpected error when register Gamma in %s", target

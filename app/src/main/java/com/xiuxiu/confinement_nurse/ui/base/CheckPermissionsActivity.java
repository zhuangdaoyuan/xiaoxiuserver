 ...
 */
public abstract class CheckPermissionsActivity extends AbsBaseActivity {

    protected abstract void loadLocationManager();
    ...
    private void showMissingPermissionDialog() {
        DialogHelper.showLocation(this, new XFunc0() {
            @Override
            public void call() {
                startAppSettings();
            }

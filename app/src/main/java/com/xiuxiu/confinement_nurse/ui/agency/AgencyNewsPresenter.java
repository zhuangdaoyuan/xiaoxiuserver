...
public class AgencyNewsPresenter extends BasePresenter<AgencyNewsContract.IView> implements AgencyNewsContract.IPresenter {


    public AgencyNewsPresenter(AgencyNewsContract.IView viewer) {
        super(viewer);
    }

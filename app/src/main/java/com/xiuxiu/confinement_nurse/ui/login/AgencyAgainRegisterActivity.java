...
import com.xiuxiu.confinement_nurse.databinding.ActivityAgencyAgainRegistersBinding;
 ...
 * 机构重新提交
 */
public class AgencyAgainRegisterActivity extends AbsBaseActivity implements PhoneNumberLoginContract.IView, AgencyRegisterContract.IView {
    private PhoneNumberLoginPresenter phoneNumberLoginPresenter;
    private ActivityAgencyAgainRegistersBinding inflate;
    private static final int IMAGE_CODE = 1;

    private AgencyRegisterContract.IPresenter mPresnter;
    public static void start(Context context) {
        Intent starter = new Intent(context, AgencyAgainRegisterActivity.class);
        context.startActivity(starter);
    }

    @Override
    protected View getLayoutView() {
        inflate = ActivityAgencyAgainRegistersBinding.inflate(LayoutInflater.from(this));
    ...
    private void setListener() {
        ...
        inflate.activityAgencyRegisterImage1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Matisse
                        .from(AgencyAgainRegisterActivity.this)
...
//                        .addFilter(new GifSizeFilter(320, 320, 5 * Filter.K * Filter.K))
    ...
    public void onNext(View view) {
        ...
        String title = inflate.activityAgencyRegisterTelephone.getTitle();
        mPresnter.requestAgainSub(phone, name, person, title);
    }
    ...
    public void onRequestAgencyInfo(AgencyInfoBean loginBean) {
        inflate.activityAgencyRegisterPhone.setText(loginBean.getOrgMobile());
        inflate.activityAgencyRegisterName.setText(loginBean.getTitle());
        inflate.activityAgencyRegisterContactPerson.setText(loginBean.getContact());
        inflate.activityAgencyRegisterTelephone.setText(loginBean.getMobile());

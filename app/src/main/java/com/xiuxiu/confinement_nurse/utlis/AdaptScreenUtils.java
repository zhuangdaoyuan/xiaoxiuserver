...
public final class AdaptScreenUtils {
     ...
     * @return value of px
     */
    public static int pt2Px(Context context, final float ptValue) {
     ...
     * @return value of pt
     */
    public static int px2Pt(Context context, final float pxValue) {
        DisplayMetrics metrics = context.getApplicationContext().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(final Resources resources, final float newXdpi) {
        ...
        getAppContext().getResources().getDisplayMetrics().xdpi = newXdpi;
